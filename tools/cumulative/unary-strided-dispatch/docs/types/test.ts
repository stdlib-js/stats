...
import UnaryStridedDispatch = require( './index' );
...
// The function returns an instance for applying a unary function...
{
	...
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, 'same' ); // $ExpectType UnaryStridedDispatch<number, number>

	const unary = UnaryStridedDispatch;
	unary<number, number>( table, [ dtypes ], dtypes, 'same' ); // $ExpectType UnaryStridedDispatch<number, number>
}
...
// The compiler throws an error if the function is provided a first argument which is not a dispatch table...
{
	...
	new UnaryStridedDispatch( '5', [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( 5, [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( true, [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( false, [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( null, [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( void 0, [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( 'abc', [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( [], [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( {}, [ dtypes ], dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch( ( x: number, y: number ): number => x + y, [ dtypes ], dtypes, 'same' ); // $ExpectError
...
// The compiler throws an error if the function is provided a second argument which is not a a list of data type lists...
{
	...
	new UnaryStridedDispatch<number, number>( table, '5', dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, 5, dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, true, dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, false, dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, null, dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, void 0, dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, 'abc', dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, {}, dtypes, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, ( x: number ): number => x, dtypes, 'same' ); // $ExpectError
...
// The compiler throws an error if the function is provided a third argument which is not a list of data types...
{
	...
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], '5', 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], 5, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], true, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], false, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], null, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], void 0, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], 'abc', 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], {}, 'same' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], ( x: number ): number => x, 'same' ); // $ExpectError
...
// The compiler throws an error if the function is provided a fourth argument which is not a recognized policy...
{
	...
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, '5' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, 5 ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, true ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, false ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, null ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, void 0 ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, 'abc' ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, {} ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, ( x: number ): number => x ); // $ExpectError
...
// The compiler throws an error if the function is provided an unsupported number of arguments...
{
	...
	new UnaryStridedDispatch(); // $ExpectError
	new UnaryStridedDispatch<number, number>( table ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ] ); // $ExpectError
	new UnaryStridedDispatch<number, number>( table, [ dtypes ], dtypes, 'same', {} ); // $ExpectError
