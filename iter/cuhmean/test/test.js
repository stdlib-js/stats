...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof itercuhmean, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object which iteratively computes a cumulative harmonic mean', function test( t ) {
	var expected;
	var actual;
	var values;
	var acc;
	...
	it = itercuhmean( array2iterator( values ) );
...
tape( 'if an environment supports `Symbol.iterator` and the provided iterator is iterable, the returned iterator is iterable', function test( t ) {
	...
	itercuhmean = proxyquire( './../lib/main.js', {
