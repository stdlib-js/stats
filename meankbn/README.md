...
> Compute the [arithmetic mean][arithmetic-mean] along one or more [ndarray][@stdlib/ndarray/ctor] dimensions using an improved Kahan–Babuška algorithm.
...
Computes the [arithmetic mean][arithmetic-mean] along one or more [ndarray][@stdlib/ndarray/ctor] dimensions using an improved Kahan–Babuška algorithm.
...
#### meankbn.assign( x, out\[, options] )

Computes the [arithmetic mean][arithmetic-mean] along one or more [ndarray][@stdlib/ndarray/ctor] dimensions using an improved Kahan–Babuška algorithm and assigns results to a provided output [ndarray][@stdlib/ndarray/ctor].
