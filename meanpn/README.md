...
> Compute the [arithmetic mean][arithmetic-mean] along one or more [ndarray][@stdlib/ndarray/ctor] dimensions using a two-pass error correction algorithm.
...
Computes the [arithmetic mean][arithmetic-mean] along one or more [ndarray][@stdlib/ndarray/ctor] dimensions using a two-pass error correction algorithm.
...
#### meanpn.assign( x, out\[, options] )

Computes the [arithmetic mean][arithmetic-mean] along one or more [ndarray][@stdlib/ndarray/ctor] dimensions using a two-pass error correction algorithm and assigns results to a provided output [ndarray][@stdlib/ndarray/ctor].
