...
Computes the [variance][variance] of a double-precision floating-point strided array `x`.
...
var v = dvariance( N, 1, x1, 2 );
// returns 6.25
```

#### dvariance.ndarray( N, correction, x, stride, offset )
...
var v = dvariance.ndarray( N, 1, x, 1, 0 );
// returns ~4.33333
```
...
var v = dvariance.ndarray( N, 1, x, 2, 1 );
// returns 6.25
```
