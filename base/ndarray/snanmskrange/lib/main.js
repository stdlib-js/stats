...
var strided = require( './../../../../strided/snanmskrange' ).ndarray;


// MAIN //

/**
* Computes the range of a one-dimensional single-precision floating-point ndarray according to a mask, ignoring `NaN` values.
*
