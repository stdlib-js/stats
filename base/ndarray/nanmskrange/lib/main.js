...
var strided = require( './../../../../strided/nanmskrange' ).ndarray;


// MAIN //

/**
* Computes the range of a one-dimensional ndarray according to a mask, ignoring `NaN` values.
*
