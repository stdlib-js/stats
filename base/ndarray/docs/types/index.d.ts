...
import dmskmaxabs = require( './../../../../base/ndarray/dmskmaxabs' );
...
import dnanmskmaxabs = require( './../../../../base/ndarray/dnanmskmaxabs' );
import dnanmskmin = require( './../../../../base/ndarray/dnanmskmin' );
import dnanmskminabs = require( './../../../../base/ndarray/dnanmskminabs' );
import dnanmskrange = require( './../../../../base/ndarray/dnanmskrange' );
import dnanrange = require( './../../../../base/ndarray/dnanrange' );
import dnanrangeabs = require( './../../../../base/ndarray/dnanrangeabs' );
import dnanstdev = require( './../../../../base/ndarray/dnanstdev' );
import dnanstdevch = require( './../../../../base/ndarray/dnanstdevch' );
import dnanstdevpn = require( './../../../../base/ndarray/dnanstdevpn' );
...
import dvariance = require( './../../../../base/ndarray/dvariance' );
...
import midrangeabs = require( './../../../../base/ndarray/midrangeabs' );
...
import nanmskmidrange = require( './../../../../base/ndarray/nanmskmidrange' );
...
import snanmskmaxabs = require( './../../../../base/ndarray/snanmskmaxabs' );
import snanmskmidrange = require( './../../../../base/ndarray/snanmskmidrange' );
import snanmskmin = require( './../../../../base/ndarray/snanmskmin' );
import snanmskminabs = require( './../../../../base/ndarray/snanmskminabs' );
...
import svariance = require( './../../../../base/ndarray/svariance' );
import svariancech = require( './../../../../base/ndarray/svariancech' );
import svariancepn = require( './../../../../base/ndarray/svariancepn' );
import svariancetk = require( './../../../../base/ndarray/svariancetk' );
import svariancewd = require( './../../../../base/ndarray/svariancewd' );
import svarianceyc = require( './../../../../base/ndarray/svarianceyc' );
...
import variancepn = require( './../../../../base/ndarray/variancepn' );
import variancetk = require( './../../../../base/ndarray/variancetk' );
import variancewd = require( './../../../../base/ndarray/variancewd' );
import varianceyc = require( './../../../../base/ndarray/varianceyc' );
...
interface Namespace {
	...
	* var Float64Vector = require( '@stdlib/ndarray/vector/float64' );
	*
	* var x = new Float64Vector( [ 1.0, -2.0, 2.0, 4.0 ] );
	*
	...
	*/
	...
	/**
	* Computes the maximum absolute value of a one-dimensional double-precision floating-point ndarray according to a mask.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	*/
	...
	/**
	* Computes the maximum absolute value of a one-dimensional double-precision floating-point ndarray according to a mask, ignoring `NaN` values.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* var mask = new Uint8Vector( [ 0, 0, 0, 0 ] );
	*
	* var v = ns.dnanmskmaxabs( [ x, mask ] );
	* // returns 2.0
	*/
	dnanmskmaxabs: typeof dnanmskmaxabs;

	/**
	* Computes the minimum value of a one-dimensional double-precision floating-point ndarray according to a mask, ignoring `NaN` values.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	*/
	...
	/**
	* Computes the minimum absolute value of a one-dimensional double-precision floating-point ndarray according to a mask, ignoring `NaN` values.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* var mask = new Uint8Vector( [ 0, 0, 0, 0 ] );
	*
	* var v = ns.dnanmskminabs( [ x, mask ] );
	* // returns 1.0
	*/
	dnanmskminabs: typeof dnanmskminabs;
	...
	* var x = new Float64Vector( [ 1.0, -2.0, NaN, 2.0 ] );
	*
	* var v = ns.dnanrangeabs( [ x ] );
	* // returns 1.0
	*/
	dnanrangeabs: typeof dnanrangeabs;
	...
	* var correction = scalar2ndarray( 1.0, opts );
	*
	* var v = ns.dnanstdev( [ x, correction ] );
	* // returns ~2.0817
	*/
	...
	* var correction = scalar2ndarray( 1.0, opts );
	*
	* var v = ns.dnanstdevch( [ x, correction ] );
	* // returns ~2.0817
	*/
	dnanstdevch: typeof dnanstdevch;

	/**
	* Computes the standard deviation of a one-dimensional double-precision floating-point ndarray, ignoring `NaN` values and using a two-pass algorithm.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* var correction = scalar2ndarray( 1.0, opts );
	*
	* var v = ns.dnanstdevpn( [ x, correction ] );
	* // returns ~2.0817
	*/
	...
	* var correction = scalar2ndarray( 1.0, opts );
	*
	* var v = ns.dvariance( [ x, correction ] );
	* // returns ~4.3333
	*/
	...
	* var x = vector( [ 1.0, -2.0, 2.0, 4.0 ], 'generic' );
	*
	* var v = ns.midrangeabs( [ x ] );
	* // returns 2.5
	*/
	midrangeabs: typeof midrangeabs;
	...
	* var mask = vector( [ 0, 0, 1, 0, 0 ], 'uint8' );
	*
	* var v = ns.nanmskmidrange( [ x, mask ] );
	* // returns 0.0
	*/
	...
	* var Float32Vector = require( '@stdlib/ndarray/vector/float32' );
	*
	* var x = new Float32Vector( [ 1.0, 3.0, NaN, 2.0 ] );
	*
	* var v = ns.snanmean( [ x ] );
	* // returns 2.0
	*/
	...
	* var mask = new Uint8Vector( [ 0, 0, 1, 0 ] );
	*
	* var v = ns.snanmskmaxabs( [ x, mask ] );
	* // returns 2.0
	*/
	snanmskmaxabs: typeof snanmskmaxabs;

	/**
	* Calculates the mid-range of a one-dimensional single-precision floating-point ndarray according to a mask, ignoring `NaN` values.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* var mask = new Uint8Vector( [ 0, 0, 1, 0, 0 ] );
	*
	* var v = ns.snanmskmidrange( [ x, mask ] );
	* // returns 0.0
	*/
	...
	* var mask = new Uint8Vector( [ 0, 0, 1, 0, 0 ] );
	*
	* var v = ns.snanmskminabs( [ x, mask ] );
	* // returns 1.0
	*/
	snanmskminabs: typeof snanmskminabs;
	...
	* });
	*
	* var v = ns.svariance( [ x, correction ] );
	* // returns ~4.3333
	*/
	svariance: typeof svariance;

	/**
	* Computes the variance of a one-dimensional single-precision floating-point ndarray using a one-pass trial mean algorithm.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* });
	*
	* var v = ns.svariancech( [ x, correction ] );
	* // returns ~4.3333
	*/
	...
	* });
	*
	* var v = ns.svariancepn( [ x, correction ] );
	* // returns ~4.3333
	*/
	svariancepn: typeof svariancepn;

	/**
	* Computes the variance of a one-dimensional single-precision floating-point ndarray using a one-pass textbook algorithm.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* });
	*
	* var v = ns.svariancetk( [ x, correction ] );
	* // returns ~4.3333
	*/
	svariancetk: typeof svariancetk;

	/**
	* Computes the variance of a one-dimensional single-precision floating-point ndarray using Welford's algorithm.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* });
	*
	* var v = ns.svariancewd( [ x, correction ] );
	* // returns ~4.3333
	*/
	svariancewd: typeof svariancewd;

	/**
	* Computes the variance of a one-dimensional single-precision floating-point ndarray using a one-pass algorithm proposed by Youngs and Cramer.
	*
	* ## Notes
	*
	* -   The function expects the following ndarrays:
	...
	* });
	*
	* var v = ns.svarianceyc( [ x, correction ] );
	* // returns ~4.3333
	*/
	...
	*
	* // Define one-dimensional input ndarrays:
	* var x = new Float32Vector( [ 4.0, 4.0, 6.0, 6.0, 5.0 ] );
	* var y = new Float32Vector( [ 3.0, 3.0, 5.0, 7.0, 7.0 ] );
	*
	* // Specify the alternative hypothesis:
	* var alt = scalar2ndarray( resolveEnum( 'two-sided' ), {
	*     'dtype': 'int8'
	...
	* });
	*
	* var v = ns.variancepn( [ x, correction ] );
	* // returns ~4.3333
	*/
	...
	* });
	*
	* var v = ns.variancetk( [ x, correction ] );
	* // returns ~4.3333
	*/
	...
	* });
	*
	* var v = ns.varianceyc( [ x, correction ] );
	* // returns ~4.3333
	*/
