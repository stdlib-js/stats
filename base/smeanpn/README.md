...
<div class="equation" align="center" data-raw-text="\mu = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@ee38ede2c8727409811efbaa225f0e3e222cbb32/lib/node_modules/@stdlib/stats/base/smeanpn/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div>
...
Computes the [arithmetic mean][arithmetic-mean] of a single-precision floating-point strided array `x` using a two-pass error correction algorithm.
...
var v = smeanpn( N, x1, 2 );
// returns 1.25
```

#### smeanpn.ndarray( N, x, stride, offset )
