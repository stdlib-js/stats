...
-   Depending on the environment, the typed versions ([`dvariance`][@stdlib/stats/strided/dvariance], [`svariance`][@stdlib/stats/base/svariance], etc.) are likely to be significantly more performant.
