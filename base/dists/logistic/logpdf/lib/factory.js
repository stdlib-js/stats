...
var degenerate = require( './../../../../../base/dists/degenerate/logpdf' ).factory;
...
function factory( mu, s ) {
	...
	/**
	* Evaluates the natural logarithm of the probability density function (PDF) for a logistic distribution.
	*
	* @private
