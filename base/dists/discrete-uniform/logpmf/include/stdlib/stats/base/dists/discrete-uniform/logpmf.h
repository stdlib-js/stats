...
#ifndef STDLIB_STATS_BASE_DISTS_DISCRETE_UNIFORM_LOGPMF_H
#define STDLIB_STATS_BASE_DISTS_DISCRETE_UNIFORM_LOGPMF_H
...
#endif // !STDLIB_STATS_BASE_DISTS_DISCRETE_UNIFORM_LOGPMF_H
