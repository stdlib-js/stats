...
var pdf = require( './../../../../../base/dists/signrank/pdf' );
...
tape( 'if provided `+infinity` for `x` and a valid `n`, the function returns `0`', function test( t ) {
	var y = pdf( PINF, 8 );
...
tape( 'if not provided a positive integer for `n`, the function returns `NaN`', function test( t ) {
	var y;
