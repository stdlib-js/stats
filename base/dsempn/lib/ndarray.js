...
var dvariancepn = require( './../../../strided/dvariancepn' ).ndarray;
...
*
* var v = dsempn( N, 1, x, 2, 1 );
* // returns 1.25
*/
function dsempn( N, correction, x, stride, offset ) {
	return sqrt( dvariancepn( N, correction, x, stride, offset ) / N );
}
