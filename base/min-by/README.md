...
-   When possible, prefer using [`dmin`][@stdlib/stats/strided/dmin], [`smin`][@stdlib/stats/base/smin], and/or [`min`][@stdlib/stats/base/min], as, depending on the environment, these interfaces are likely to be significantly more performant.
