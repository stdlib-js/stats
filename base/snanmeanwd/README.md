...
<div class="equation" align="center" data-raw-text="\mu = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@b4a9aa236bee780c0683f9ff2bb56a813bda66ba/lib/node_modules/@stdlib/stats/base/snanmeanwd/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div>
...
var v = snanmeanwd( N, x1, 2 );
// returns 1.25
```

#### snanmeanwd.ndarray( N, x, stride, offset )
...
var v = snanmeanwd.ndarray( N, x, 1, 0 );
// returns ~0.33333
```
...
var v = snanmeanwd.ndarray( N, x, 2, 1 );
// returns 1.25
```
