...
```javascript
statistics = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats@v0.3.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats@v0.3.3-umd/browser.js"></script>
```
