...
> Compute the maximum value along one or more [ndarray][@stdlib/ndarray/ctor] dimensions according to a callback function, ignoring `NaN` values.
...
```javascript
var nanmaxBy = require( '@stdlib/stats/nanmax-by' );
```

#### nanmaxBy( x\[, options], clbk\[, thisArg] )

Computes the maximum value along one or more [ndarray][@stdlib/ndarray/ctor] dimensions according to a callback function, ignoring `NaN` values.
...
#### nanmaxBy.assign( x, out\[, options], clbk\[, thisArg] )

Computes the maximum value along one or more [ndarray][@stdlib/ndarray/ctor] dimensions according to a callback function, ignoring `NaN` values, and assigns results to a provided output [ndarray][@stdlib/ndarray/ctor].
...
var y = nanmaxBy( x, opts, accessor );
