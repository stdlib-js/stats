...
var incrmmape = require( './../../../incr/mmape' );


// MAIN //

/**
* Returns an accumulator function which incrementally computes a moving mean absolute percentage error, ignoring `NaN` values.
*
...
* // returns ~86.67
*/
function incrnanmmape( W ) {
	var mmape = incrmmape( W );
	return accumulator;
