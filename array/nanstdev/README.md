...
> Calculate the [standard deviation][standard-deviation] of an array ignoring `NaN` values.
...
```javascript
var nanstdev = require( '@stdlib/stats/array/nanstdev' );
```

#### nanstdev( x\[, correction] )

Computes the [standard deviation][standard-deviation] of an array ignoring `NaN` values.
