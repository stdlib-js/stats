...
> Calculate the [variance][variance] of an array ignoring `NaN` values and using Welford's algorithm.
...
```javascript
var nanvariancewd = require( '@stdlib/stats/array/nanvariancewd' );
```

#### nanvariancewd( x\[, correction] )
