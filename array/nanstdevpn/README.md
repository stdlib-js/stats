...
> Calculate the [standard deviation][standard-deviation] of an array ignoring `NaN` values and using a two-pass algorithm.
...
```javascript
var nanstdevpn = require( '@stdlib/stats/array/nanstdevpn' );
```

#### nanstdevpn( x\[, correction] )

Computes the [standard deviation][standard-deviation] of an array ignoring `NaN` values and using a two-pass algorithm.
