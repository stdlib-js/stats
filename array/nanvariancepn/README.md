...
> Calculate the [variance][variance] of an array ignoring `NaN` values and using a two-pass algorithm.
...
```javascript
var nanvariancepn = require( '@stdlib/stats/array/nanvariancepn' );
```

#### nanvariancepn( x\[, correction] )
