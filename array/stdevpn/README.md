...
> Calculate the [standard deviation][standard-deviation] of an array using a two-pass algorithm.
...
Computes the [standard deviation][standard-deviation] of an array using a two-pass algorithm.
