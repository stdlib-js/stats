...
> Calculate the [standard deviation][standard-deviation] of an array ignoring `NaN` values and using a one-pass algorithm proposed by Youngs and Cramer.
...
```javascript
var nanstdevyc = require( '@stdlib/stats/array/nanstdevyc' );
```

#### nanstdevyc( x\[, correction] )

Computes the [standard deviation][standard-deviation] of an array ignoring `NaN` values and using a one-pass algorithm proposed by Youngs and Cramer.
