...
> Calculate the [variance][variance] of an array using Welford's algorithm.
...
```javascript
var variancewd = require( '@stdlib/stats/array/variancewd' );
```

#### variancewd( x\[, correction] )
