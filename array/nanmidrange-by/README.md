...
> Calculate the [mid-range][mid-range] of an array via a callback function, ignoring `NaN` values.
...
Computes the [mid-range][mid-range] of an array via a callback function, ignoring `NaN` values.
