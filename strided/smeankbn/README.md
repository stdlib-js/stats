...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@71e99951f1abf7e79d5749b45e2fdac90d853b85/lib/node_modules/@stdlib/stats/strided/smeankbn/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div> -->
...
```javascript
var smeankbn = require( '@stdlib/stats/strided/smeankbn' );
```
...
var v = smeankbn.ndarray( x.length, x, 1, 0 );
// returns ~0.33333
```
...
float v = stdlib_strided_smeankbn( 4, x, 2 );
// returns 4.0f
```
...
```c
float stdlib_strided_smeankbn( const CBLAS_INT N, const float *X, const CBLAS_INT strideX );
```
...
float v = stdlib_strided_smeankbn_ndarray( 4, x, 2, 0 );
// returns 4.0f
```
...
```c
float stdlib_strided_smeankbn_ndarray( const CBLAS_INT N, const float *X, const CBLAS_INT strideX, const CBLAS_INT offsetX );
```
