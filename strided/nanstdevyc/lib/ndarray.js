...
*
* var v = nanstdevyc( 5, 1, x, 2, 1 );
* // returns 2.5
*/
function nanstdevyc( N, correction, x, strideX, offsetX ) {
	return sqrt( nanvarianceyc( N, correction, x, strideX, offsetX ) );
}


// EXPORTS //

module.exports = nanstdevyc;
