...
<!-- <div class="equation" align="center" data-raw-text="\sigma_{\bar{x}} = \frac{\sigma}{\sqrt{n}}" data-equation="eq:standard_error_of_the_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@e541455edad5251f526b8cc13e60c7d00b4b6767/lib/node_modules/@stdlib/stats/strided/dsemyc/docs/img/equation_standard_error_of_the_mean.svg" alt="Equation for the standard error of the mean.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\sigma_{\bar{x}} \approx \frac{s}{\sqrt{n}}" data-equation="eq:standard_error_of_the_mean_estimate">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@e541455edad5251f526b8cc13e60c7d00b4b6767/lib/node_modules/@stdlib/stats/strided/dsemyc/docs/img/equation_standard_error_of_the_mean_estimate.svg" alt="Equation for estimating the standard error of the mean.">
    <br>
</div> -->
...
```javascript
var dsemyc = require( '@stdlib/stats/strided/dsemyc' );
```
