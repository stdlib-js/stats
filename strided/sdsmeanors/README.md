...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@9574215d8f1ec3317909171013cf282fd8db9b91/lib/node_modules/@stdlib/stats/strided/sdsmeanors/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div> -->
...
```javascript
var sdsmeanors = require( '@stdlib/stats/strided/sdsmeanors' );
```
...
```c
#include "stdlib/stats/strided/sdsmeanors.h"
```
