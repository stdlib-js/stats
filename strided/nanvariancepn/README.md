...
-   Depending on the environment, the typed versions ([`dnanvariancepn`][@stdlib/stats/strided/dnanvariancepn], [`snanvariancepn`][@stdlib/stats/base/snanvariancepn], etc.) are likely to be significantly more performant.
