...
var sztest = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
...
tape( 'the function performs a one-sample Z-test over a strided array (alternative=two-sided)', opts, function test( t ) {
	...
	out = sztest( x.length, 'two-sided', 0.1, 0.0, 1.0, x, 1, 0, results );
	...
	out = sztest( x.length, 'two-sided', 0.1, 100.0, 1.0, x, 1, 0, results );
	t.strictEqual( out, results, 'returns expected value' );
...
tape( 'the function performs a one-sample Z-test over a strided array (alternative=greater)', opts, function test( t ) {
	...
	out = sztest( x.length, 'greater', 0.1, 0.0, 1.0, x, 1, 0, results );
	t.strictEqual( out, results, 'returns expected value' );
	t.strictEqual( out.rejected, false, 'returns expected value' );
...
tape( 'the function performs a one-sample Z-test over a strided array (alternative=less)', opts, function test( t ) {
	...
	out = sztest( x.length, 'less', 0.1, 0.0, 1.0, x, 1, 0, results );
	t.strictEqual( out, results, 'returns expected value' );
	t.strictEqual( out.rejected, false, 'returns expected value' );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN` results', opts, function test( t ) {
	...
	out = sztest( 0, 'two-sided', 0.1, 0.0, 1.0, x, 1, 0, results );
	t.strictEqual( out, results, 'returns expected value' );
	t.strictEqual( out.rejected, false, 'returns expected value' );
	t.strictEqual( out.alternative, 'two-sided', 'returns expected value' );
	...
	out = sztest( -1, 'two-sided', 0.1, 0.0, 1.0, x, 1, 0, results );
	t.strictEqual( out, results, 'returns expected value' );
	t.strictEqual( out.rejected, false, 'returns expected value' );
	t.strictEqual( out.alternative, 'two-sided', 'returns expected value' );
	t.strictEqual( isnanf( out.statistic ), true, 'returns expected value' );
...
tape( 'the function supports a stride parameter', opts, function test( t ) {
	...
	out = sztest( N, 'two-sided', 0.1, 0.0, 1.0, x, 2, 0, results );
	t.strictEqual( out, results, 'returns expected value' );
	t.strictEqual( out.rejected, false, 'returns expected value' );
	t.strictEqual( out.alternative, 'two-sided', 'returns expected value' );
	t.strictEqual( isnanf( out.statistic ), false, 'returns expected value' );
...
tape( 'the function supports a negative stride parameter', opts, function test( t ) {
	...
	out = sztest( N, 'two-sided', 0.1, 0.0, 1.0, x, -2, (N-1)*2, results );
	t.strictEqual( out, results, 'returns expected value' );
	t.strictEqual( out.rejected, false, 'returns expected value' );
	t.strictEqual( out.alternative, 'two-sided', 'returns expected value' );
	t.strictEqual( isnanf( out.statistic ), false, 'returns expected value' );
...
tape( 'the function supports an offset parameter', opts, function test( t ) {
	...
	out = sztest( N, 'two-sided', 0.1, 0.0, 1.0, x, 2, 1, results );
	t.strictEqual( out, results, 'returns expected value' );
	t.strictEqual( out.rejected, false, 'returns expected value' );
	t.strictEqual( out.alternative, 'two-sided', 'returns expected value' );
	t.strictEqual( isnanf( out.statistic ), false, 'returns expected value' );
