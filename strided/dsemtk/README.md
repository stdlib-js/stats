...
<!-- <div class="equation" align="center" data-raw-text="\sigma_{\bar{x}} = \frac{\sigma}{\sqrt{n}}" data-equation="eq:standard_error_of_the_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@5801695664293426455789e96b013ef4320d0569/lib/node_modules/@stdlib/stats/strided/dsemtk/docs/img/equation_standard_error_of_the_mean.svg" alt="Equation for the standard error of the mean.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\sigma_{\bar{x}} \approx \frac{s}{\sqrt{n}}" data-equation="eq:standard_error_of_the_mean_estimate">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@5801695664293426455789e96b013ef4320d0569/lib/node_modules/@stdlib/stats/strided/dsemtk/docs/img/equation_standard_error_of_the_mean_estimate.svg" alt="Equation for estimating the standard error of the mean.">
    <br>
</div> -->
...
```javascript
var dsemtk = require( '@stdlib/stats/strided/dsemtk' );
```
...
var v = dsemtk( 4, 1, x1, 2 );
// returns 1.25
```

#### dsemtk.ndarray( N, correction, x, strideX, offsetX )
...
var v = dsemtk.ndarray( x.length, 1, x, 1, 0 );
// returns ~1.20185
```
...
```c
#include "stdlib/stats/strided/dsemtk.h"
```

#### stdlib_strided_dsemtk( N, correction, \*X, strideX )

Computes the [standard error of the mean][standard-error] of a double-precision floating-point strided array using a one-pass textbook algorithm.

```c
const double x[] = { 1.0, -2.0, 2.0 };

double v = stdlib_strided_dsemtk( 3, 1.0, x, 1 );
// returns ~1.20185
```
...
```c
double stdlib_strided_dsemtk( const CBLAS_INT N, const double correction, const double *X, const CBLAS_INT strideX );
```

#### stdlib_strided_dsemtk_ndarray( N, correction, \*X, strideX, offsetX )
...
double v = stdlib_strided_dsemtk_ndarray( 3, 1.0, x, 1, 0 );
// returns ~1.20185
```
...
```c
double stdlib_strided_dsemtk_ndarray( const CBLAS_INT N, const double correction, const double *X, const CBLAS_INT strideX, const CBLAS_INT offsetX );
```
