...
var dpcorr = require( './../../../../strided/dpcorr' ).ndarray;
...
*
* var v = dcorrelation( x.length, x, 1, 0, y, 1, 0 );
* // returns ~0.115
*/
function dcorrelation( N, x, strideX, offsetX, y, strideY, offsetY ) {
	if ( N <= 0 ) {
		return NaN;
	}
	return 1 - dpcorr( N, x, strideX, offsetX, y, strideY, offsetY );
}


// EXPORTS //

module.exports = dcorrelation;
