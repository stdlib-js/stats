...
<!-- <equation class="equation" label="eq:euclidean_distance" align="center" raw="d(X,Y) = \left\lVert X - Y \right\rVert = \sqrt{\sum_{i=0}^{N-1} (y_i - x_i)^2}" alt="Equation for the Euclidean distance."> -->
