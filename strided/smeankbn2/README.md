...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@382291df7e9a618515aa6f25847b0ed24be72b6d/lib/node_modules/@stdlib/stats/strided/smeankbn2/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div> -->
...
```javascript
var smeankbn2 = require( '@stdlib/stats/strided/smeankbn2' );
```

#### smeankbn2( N, x, strideX )

Computes the [arithmetic mean][arithmetic-mean] of a single-precision floating-point strided array using a second-order iterative Kahan–Babuška algorithm.
...
var v = smeankbn2( 4, x1, 2 );
// returns 1.25
```

#### smeankbn2.ndarray( N, x, strideX, offsetX )
...
var v = smeankbn2.ndarray( x.length, x, 1, 0 );
// returns ~0.33333
```
...
```c
#include "stdlib/stats/strided/smeankbn2.h"
```

#### stdlib_strided_smeankbn2( N, \*X, strideX )
...
float v = stdlib_strided_smeankbn2( 4, x, 2 );
// returns 4.0f
```
...
```c
float stdlib_strided_smeankbn2( const CBLAS_INT N, const float *X, const CBLAS_INT strideX );
```

#### stdlib_strided_smeankbn2_ndarray( N, \*X, strideX, offsetX )
...
float v = stdlib_strided_smeankbn2_ndarray( 4, x, 2, 0 );
// returns 4.0f
```
...
```c
float stdlib_strided_smeankbn2_ndarray( const CBLAS_INT N, const float *X, const CBLAS_INT strideX, const CBLAS_INT offsetX );
```
...
int main( void ) {
    ...
    float v = stdlib_strided_smeankbn2( N, x, strideX );
