...
* @return            output value
*/
double API_SUFFIX(stdlib_strided_dnanstdevtk)( const CBLAS_INT N, const double correction, const double *X, const CBLAS_INT strideX ) {
	const CBLAS_INT ox = stdlib_strided_stride2offset( N, strideX );
	return API_SUFFIX(stdlib_strided_dnanstdevtk_ndarray)( N, correction, X, strideX, ox );
}
