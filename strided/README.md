...
-   <span class="signature">[`dmidrangeabs( N, x, strideX )`][@stdlib/stats/strided/dmidrangeabs]</span><span class="delimiter">: </span><span class="description">compute the mid-range of absolute values of a double-precision floating-point strided array.</span>
