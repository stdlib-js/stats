...
```javascript
var stdevch = require( '@stdlib/stats/strided/stdevch' );
```

#### stdevch( N, correction, x, strideX )

Computes the [standard deviation][standard-deviation] of a strided array using a one-pass trial mean algorithm.
...
var v = stdevch( 4, 1, x1, 2 );
// returns 2.5
```

#### stdevch.ndarray( N, correction, x, strideX, offsetX )
...
var v = stdevch.ndarray( 4, 1, x, 2, 1 );
// returns 2.5
```
