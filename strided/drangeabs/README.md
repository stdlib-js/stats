...
#### drangeabs( N, x, strideX )

Computes the [range][range] of absolute values of a double-precision floating-point strided array.
...
#### drangeabs.ndarray( N, x, strideX, offsetX )

Computes the [range][range] of absolute values of a double-precision floating-point strided array using alternative indexing semantics.
...
```c
#include "stdlib/stats/strided/drangeabs.h"
```

#### stdlib_strided_drangeabs( N, \*X, strideX )
...
```c
double stdlib_strided_drangeabs( const CBLAS_INT N, const double *X, const CBLAS_INT strideX );
```

#### stdlib_strided_drangeabs_ndarray( N, \*X, strideX, offsetX )
...
```c
double stdlib_strided_drangeabs_ndarray( const CBLAS_INT N, const double *X, const CBLAS_INT strideX, const CBLAS_INT offsetX );
```
