...
> Compute the maximum absolute value along one or more [ndarray][@stdlib/ndarray/ctor] dimensions, ignoring `NaN` values.
...
```javascript
var nanmaxabs = require( '@stdlib/stats/nanmaxabs' );
```

#### nanmaxabs( x\[, options] )

Computes the maximum absolute value along one or more [ndarray][@stdlib/ndarray/ctor] dimensions, ignoring `NaN` values.
...
#### nanmaxabs.assign( x, out\[, options] )

Computes the maximum absolute value along one or more [ndarray][@stdlib/ndarray/ctor] dimensions, ignoring `NaN` values, and assigns results to a provided output [ndarray][@stdlib/ndarray/ctor].
